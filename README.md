...
Проверка
Выполнил npm pack
Пакет успешно упакован как create-bard-project@0.0.1
Временный tarball удалил
Как использовать сейчас
Как будет работать после GitHub публикации
Важно

npx create-bard-project MyApp будет работать после публикации пакета на npm как create-bard-project

пока пакет не опубликован, используйте локальную установку или установку напрямую из GitHub
Если нужно, могу ещё:
